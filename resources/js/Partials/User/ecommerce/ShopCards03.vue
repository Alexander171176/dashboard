...
<template>
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-09.jpg" width="286" height="160"
                     alt="Application 09"/>
                <!-- Like button -->
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-10.jpg" width="286" height="160"
                     alt="Application 10"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-11.jpg" width="286" height="160"
                     alt="Application 11"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-12.jpg" width="286" height="160"
                     alt="Application 12"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
