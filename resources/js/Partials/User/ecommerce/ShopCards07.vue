...
<template>
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-21.jpg" width="301" height="226"
                     alt="Application 21"/>
                <!-- Like button -->
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-22.jpg" width="301" height="226"
                     alt="Application 22"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-23.jpg" width="301" height="226"
                     alt="Application 23"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-24.jpg" width="301" height="226"
                     alt="Application 24"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-25.jpg" width="301" height="226"
                     alt="Application 25"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-26.jpg" width="301" height="226"
                     alt="Application 26"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-27.jpg" width="301" height="226"
                     alt="Application 27"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-28.jpg" width="301" height="226"
                     alt="Application 28"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-29.jpg" width="301" height="226"
                     alt="Application 29"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div class="col-span-full md:order-1 xl:order-none">
        <div
            class="h-full p-6 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:justify-between xl:items-center">
            <div class="mb-4 xl:mb-0 xl:mr-4">
                <div class="text-xl text-slate-50 font-semibold mb-1">Excepteur sint occaecat <span
                    class="text-indigo-500">cupidatat</span> 🎁
                </div>
                <div class="m-auto text-sm text-slate-400">Excepteur sint occaecat cupidatat non proidentsunt in culpa
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-30.jpg" width="301" height="226"
                     alt="Application 30"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-31.jpg" width="301" height="226"
                     alt="Application 31"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-32.jpg" width="301" height="226"
                     alt="Application 32"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
