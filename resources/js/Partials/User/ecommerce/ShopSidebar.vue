                    ...
                    <ul class="space-y-2">
                        <li>
                            ...
                            <button class="flex items-center space-x-2 mr-2">
                                ...
                                <div class="inline-flex text-sm text-slate-500 italic"><span
                                    class="sr-only">4 Stars</span> And up
                                </div>
                            </button>
                        </li>
                        <li>
                            ...
                            <button class="flex items-center space-x-2 mr-2">
                                ...
                                <div class="inline-flex text-sm text-slate-500 italic"><span
                                    class="sr-only">3 Stars</span> And up
                                </div>
                            </button>
                        </li>
                        <li>
                            ...
                            <button class="flex items-center space-x-2 mr-2">
                                ...
                                <div class="inline-flex text-sm text-slate-500 italic"><span
                                    class="sr-only">2 Stars</span> And up
                                </div>
                            </button>
                        </li>
                        <li>
                            ...
                            <button class="flex items-center space-x-2 mr-2">
                                ...
                                <div class="inline-flex text-sm text-slate-500 italic"><span
                                    class="sr-only">1 Stars</span> And up
                                </div>
                            </button>
                        </li>
                    </ul>
