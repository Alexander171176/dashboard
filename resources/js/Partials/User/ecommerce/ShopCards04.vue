...
<template>
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-13.jpg" width="286" height="160"
                     alt="Application 13"/>
                <!-- Like button -->
            ...
            <div class="grow flex flex-col p-5">
                ...
                <div class="grow">
                    <!-- Header -->
                    <header class="mb-4">
                        <a class="text-xs text-emerald-500 hover:text-emerald-600 font-semibold uppercase tracking-widest mb-1"
                           href="#0">Funding</a>
                    ...
                    <div class="mb-5">
                        <div class="flex justify-between text-sm space-x-2 mb-2">
                            <div><span class="font-semibold text-slate-800">$789,784</span> <span
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-14.jpg" width="286" height="160"
                     alt="Application 14"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-15.jpg" width="286" height="160"
                     alt="Application 15"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-16.jpg" width="286" height="160"
                     alt="Application 16"/>
                <!-- Like button -->
                <button class="absolute top-0 right-0 mt-4 mr-4">
                    <div class="text-slate-100 bg-slate-900 bg-opacity-60 rounded-full">
