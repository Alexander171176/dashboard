...
<template>
    ...
    <div
        ...
        <!-- Image -->
        <img class="absolute w-full h-full object-cover" src="../../../../images/applications-image-17.jpg" width="286"
    ...
    <div
        class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        <!-- Image -->
        <img class="absolute w-full h-full object-cover" src="../../../../images/applications-image-18.jpg" width="286"
             height="160" alt="Application 18"/>
        <!-- Gradient -->
        <div class="absolute inset-0 bg-gradient-to-t from-slate-800 to-transparent" aria-hidden="true"></div>
        <!-- Content -->
        <div class="relative h-full p-5 flex flex-col justify-end">
    ...
    <div
        class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        <!-- Image -->
        <img class="absolute w-full h-full object-cover" src="../../../../images/applications-image-19.jpg" width="286"
             height="160" alt="Application 19"/>
        <!-- Gradient -->
        <div class="absolute inset-0 bg-gradient-to-t from-slate-800 to-transparent" aria-hidden="true"></div>
        <!-- Content -->
        <div class="relative h-full p-5 flex flex-col justify-end">
    ...
    <div
        class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        <!-- Image -->
        <img class="absolute w-full h-full object-cover" src="../../../../images/applications-image-20.jpg" width="286"
             height="160" alt="Application 20"/>
        <!-- Gradient -->
        <div class="absolute inset-0 bg-gradient-to-t from-slate-800 to-transparent" aria-hidden="true"></div>
        <!-- Content -->
        <div class="relative h-full p-5 flex flex-col justify-end">
