...
<template>
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-05.jpg" width="286" height="160"
                     alt="Application 05"/>
                <!-- Popular label -->
            ...
            <div class="grow flex flex-col p-5">
                ...
                <div class="grow">
                    ...
                    <header class="mb-2">
                        ...
                        <div class="text-sm">Master Digital Marketing Strategy, Social Media Marketing, Analytics &
                            More!
                        </div>
                    </header>
                    <!-- Rating and Price -->
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-06.jpg" width="286" height="160"
                     alt="Application 06"/>
            </div>
            <!-- Card Content -->
            <div class="grow flex flex-col p-5">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-07.jpg" width="286" height="160"
                     alt="Application 07"/>
            </div>
            <!-- Card Content -->
            <div class="grow flex flex-col p-5">
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <div class="relative">
                <img class="w-full" src="../../../../images/applications-image-08.jpg" width="286" height="160"
                     alt="Application 08"/>
            </div> <!-- Card Content -->
            <div class="grow flex flex-col p-5">
                <!-- Card body -->
