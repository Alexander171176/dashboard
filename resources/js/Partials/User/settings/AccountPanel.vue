        ...
        <div class="p-6 space-y-6">
            ...
            <section>
                ...
                <div class="flex flex-wrap mt-5">
                    ...
                    <button class="btn border-slate-200 hover:border-slate-300 shadow-sm text-indigo-500">Change
                    </button>
                </div>
            </section>
            <!-- Password -->
            <section>
                ...
                <div class="text-sm">You can set a permanent password if you don't want to use temporary login codes.
                </div>
                <div class="mt-5">
            ...
            <section>
                ...
                <div class="text-sm">With this update, online-only files will no longer appear to take up hard drive
                    space.
                </div>
