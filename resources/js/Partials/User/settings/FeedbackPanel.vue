...
<template>
    <div class="grow">
        ...
        <div class="p-6 space-y-6">
            ...
            <!-- Rate -->
            <section>
                <h3 class="text-xl leading-snug text-slate-800 font-bold mb-6">How likely would you recommend us to a
                    friend or colleague?</h3>
            ...
            <section>
                ...
                <textarea id="feedback" class="form-textarea w-full focus:border-slate-300" rows="4"
