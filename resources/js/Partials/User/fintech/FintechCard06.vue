    ...
    <div class="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
        ...
        <div class="p-3">
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="shrink-0 rounded-full mr-2 sm:mr-3">
                                    <img class="w-9 h-9 rounded-full" src="../../../../images/user-36-05.jpg" width="36"
                                         height="36" alt="User 05"/>
                                </div>
            ...
            <div class="text-center border-t border-slate-100 px-2">
                <a class="block text-sm font-medium text-indigo-500 hover:text-indigo-600 pt-4 pb-1" href="#0">View All
                    -&gt;</a>
            </div>
