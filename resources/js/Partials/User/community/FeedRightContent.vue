                                    ...
                                    <div class="grow flex items-center">
                                        <div class="relative mr-3">
                                            <img class="w-8 h-8 rounded-full"
                                                 src="../../../../images/group-avatar-01.png" width="32" height="32"
                                                 alt="Group 01"/>
                                        </div>
                                        <div class="truncate">
                            ...
                            <li>
                                <div class="flex items-center justify-between">
                                    <div class="grow flex items-center">
                                        <div class="relative mr-3">
                                            <img class="w-8 h-8 rounded-full"
                                                 src="../../../../images/group-avatar-02.png" width="32" height="32"
                                                 alt="Group 02"/>
                                        </div>
                                        <div class="truncate">
                            ...
                            <li>
                                <div class="flex items-center justify-between">
                                    <div class="grow flex items-center">
                                        <div class="relative mr-3">
                                            <img class="w-8 h-8 rounded-full"
                                                 src="../../../../images/group-avatar-03.png" width="32" height="32"
                                                 alt="Group 03"/>
                                        </div>
                                        <div class="truncate">
                            ...
                            <li>
                                <div class="flex items-center justify-between">
                                    <div class="grow flex items-center">
                                        <div class="relative mr-3">
                                            <img class="w-8 h-8 rounded-full"
                                                 src="../../../../images/group-avatar-04.png" width="32" height="32"
                                                 alt="Group 04"/>
                                        </div>
                                        <div class="truncate">
                        ...
                        <ul class="space-y-3">
                            <li>
                                <div class="text-sm mb-1">
                                    <a class="font-medium text-slate-800" href="#0">Tracking your website traffic on
                                        launch day 📈</a>
                                </div>
                            ...
                            <li>
                                <div class="text-sm mb-1">
                                    <a class="font-medium text-slate-800" href="#0">Who owns user onboarding in your
                                        company?</a>
                                </div>
                            ...
                            <li>
                                <div class="text-sm mb-1">
                                    <a class="font-medium text-slate-800" href="#0">Questions from a very confused Web3
                                        startup founder 🤔</a>
                                </div>
