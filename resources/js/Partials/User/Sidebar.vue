            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <SidebarLinkGroup v-slot="parentLink"
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    ...
                                    <router-link :to="{ name: 'dashboard-analytics' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-fintech' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                        ...
                        <!-- E-Commerce  -->
                        <SidebarLinkGroup v-slot="parentLink"
                                          :activeCondition="currentRoute.fullPath.includes('dashboard-ecommerce')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-ecommerce-customers' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-orders' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-invoices' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-shop' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-shop-2' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-product' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-cart' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-cart-2' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-cart-3' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-ecommerce-pay' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                        ...
                        <!-- Community -->
                        <SidebarLinkGroup v-slot="parentLink"
                                          :activeCondition="currentRoute.fullPath.includes('dashboard-community')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-community-users-1' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/community/users-1'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-users-2' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/community/users-2'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-profile' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-feed' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-forum' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-post' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/community/post'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-meetups-1' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/community/meetups-1'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-community-meetups-2' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/community/meetups-2'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                        ...
                        <!-- Finance -->
                        <SidebarLinkGroup v-slot="parentLink"
                                          :activeCondition="currentRoute.fullPath.includes('dashboard-finance')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-finance-cards' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-finance-transactions' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-finance-transaction-2' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/finance/transaction-2'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                        ...
                        <!-- Job Board -->
                        <SidebarLinkGroup v-slot="parentLink" :activeCondition="currentRoute.fullPath.includes('dashboard-job')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-job-listing' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/job/listing'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-job-post' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-job-company' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/job/company'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                        ...
                        <!-- Tasks -->
                        <SidebarLinkGroup v-slot="parentLink"
                                          :activeCondition="currentRoute.fullPath.includes('dashboard-tasks')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-tasks-kanban' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-tasks-list' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                        ...
                        <SidebarLinkGroup v-slot="parentLink"
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-settings-account' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-settings-notifications' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-settings-apps' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-settings-plans' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-settings-billing' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-settings-feedback' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                        ...
                        <!-- Utility -->
                        <SidebarLinkGroup v-slot="parentLink"
                                          :activeCondition="currentRoute.fullPath.includes('dashboard-utility')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-utility-changelog' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-utility-roadmap' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-utility-faqs' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-utility-empty' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/utility/empty'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-utility-404' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-utility-knowledge' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/utility/knowledge'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                        ...
                        <!-- Components  -->
                        <SidebarLinkGroup v-slot="parentLink"
                                          :activeCondition="currentRoute.fullPath.includes('dashboard-component')">
                            <a class="block text-slate-200 truncate transition duration-150"
                               href="#0"
                               @click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
                                <div class="flex items-center justify-between">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-component-button' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-form' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-dropdown' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-alert' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-modal' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-pagination' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-tabs' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-breadcrumb' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-badge' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-avatar' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-tooltip' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-accordion' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-component-icons' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                        ...
                        <LinkGroup :href="route('dashboard.messages.index')" :active="route().current('dashboard.messages.index')"
                        ...
                        <!-- Inbox route Inertia -->
                        <LinkGroup :href="route('dashboard.inbox.index')" :active="route().current('dashboard.inbox.index')"
                                   class="mt-2 mb-4 block truncate transition duration-150">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        ...
                        <LinkGroup :href="route('dashboard.calendar.index')" :active="route().current('dashboard.calendar.index')"
                                   class="mt-2 mb-4 block truncate transition duration-150">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        ...
                        <LinkGroup :href="route('dashboard.campaigns.index')" :active="route().current('dashboard.campaigns.index')"
                                   class="mt-2 mb-4 block truncate transition duration-150">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <SidebarLinkGroup v-slot="parentLink">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-signin' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-registration' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                                ...
                                                :href="href || '/dashboard/registration'"
                                                @click="() => { navigate(); }"
                                            >
                                                <span
                                    ...
                                    <router-link :to="{ name: 'dashboard-password' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                        ...
                        <SidebarLinkGroup v-slot="parentLink">
                            ...
                            <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                                    <router-link :to="{ name: 'dashboard-step-1' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-step-2' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-step-3' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
                                    ...
                                    <router-link :to="{ name: 'dashboard-step-4' }" custom
                                                 v-slot="{ href, navigate, isExactActive }">
                                        <li class="mb-1 last:mb-0">
                                            <a
                                                class="block transition duration-150 truncate"
