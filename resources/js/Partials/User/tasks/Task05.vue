    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
        ...
        <div class="mb-3">
            ...
            <div>
                ...
                <img class="w-full mt-3" src="../../../../images/task-image-01.jpg" width="259" height="142"
                     alt="Task 01"/>
            </div>
        </div>
        <!-- Footer -->
        <div class="flex items-center justify-between">
            ...
            <div class="flex shrink-0 -space-x-3 -ml-px">
                <a class="block" href="#0">
                    <img class="rounded-full border-2 border-white box-content" src="../../../../images/user-28-05.jpg"
