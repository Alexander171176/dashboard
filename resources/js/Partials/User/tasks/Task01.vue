...
<template>
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
        ...
        <div class="mb-3">
            ...
            <!-- Content -->
            <div>
                <div class="text-sm">#7764 created by <a class="font-medium text-slate-800 hover:underline" href="#0">markus-james</a>
                </div>
            </div>
        </div>
        <!-- Footer -->
        <div class="flex items-center justify-between">
            ...
            <div class="flex shrink-0 -space-x-3 -ml-px">
                <a class="block" href="#0">
                    <img class="rounded-full border-2 border-white box-content" src="../../../../images/user-28-07.jpg"
                         width="28" height="28" alt="User 07"/>
                </a>
                <a class="block" href="#0">
                    <img class="rounded-full border-2 border-white box-content" src="../../../../images/user-28-11.jpg"
                         width="28" height="28" alt="User 11"/>
                </a>
            </div>
            <!-- Right side -->
