            ...
            <div>
                ...
                <div class="px-5 py-4">
                    ...
                    <div class="mt-4">
                        ...
                        <ul class="mb-6">
                            <li class="-mx-2">
                                <button class="flex w-full p-2 rounded bg-indigo-100 text-left"
                                        @click.stop="$emit('close-inboxsidebar')">
                                    <img class="w-8 h-8 rounded-full mr-2" src="../../../../images/user-32-01.jpg"
                                         width="32" height="32" alt="User 01"/>
                                    <div class="grow truncate">
                                        <div class="flex items-center justify-between mb-1.5">
                                            <div class="truncate">
                                                <span
                                                    class="text-sm font-semibold text-slate-800">Dominik Lamakani</span>
                                            </div>
                                            <div class="text-xs text-slate-500 font-medium">4 Aug</div>
                                        </div>
                                        <div class="text-xs font-medium text-slate-800 truncate mb-0.5">Chill your mind
                                            with this amazing offer 🎉
                                        </div>
                                        <div class="text-xs whitespace-normal">Lorem ipsum dolor sit amet, consecte
                                            adipiscing elit aute irure dolor…
                                        </div>
                                    </div>
                                </button>
                            </li>
                            <li class="-mx-2">
                                <button class="flex w-full p-2 rounded text-left"
                                        @click.stop="$emit('close-inboxsidebar')">
                                    <img class="w-8 h-8 rounded-full mr-2" src="../../../../images/user-32-05.jpg"
                                    ...
                                    <div class="grow truncate">
                                        ...
                                        <div class="text-xs font-medium text-slate-800 truncate mb-0.5">🙌 Help us
                                            improve Mosaic by giving…
                                        </div>
                                        <div class="text-xs whitespace-normal">Lorem ipsum dolor sit amet, consecte
                                            adipiscing elit aute irure dolor…
                                        </div>
                            ...
                            <li class="-mx-2">
                                <button class="flex w-full p-2 rounded text-left"
                                        @click.stop="$emit('close-inboxsidebar')">
                                    <img class="w-8 h-8 rounded-full mr-2" src="../../../../images/user-32-06.jpg"
                                         width="32" height="32" alt="User 05"/>
                                    <div class="grow truncate">
                                        <div class="flex items-center justify-between mb-1.5">
                                            <div class="truncate">
                                                <span
                                                    class="text-sm font-semibold text-slate-800">Mary Roszczewski</span>
                                            </div>
                                            <div class="text-xs text-slate-500 font-medium">1 Aug</div>
                                        </div>
                                        <div class="text-xs font-medium text-slate-800 truncate mb-0.5">[Urgent] Changes
                                            to links for public…
                                        </div>
                                        <div class="text-xs whitespace-normal">👋 Lorem ipsum dolor sit amet, consecte
                                            adipiscing elit aute irure dolor…
                                ...
                                <button class="flex w-full p-2 rounded text-left"
                                    ...
                                    <div class="grow truncate">
                                        <div class="flex items-center justify-between mb-1.5">
                                            <div class="truncate">
                                                <span
                                                    class="text-sm font-semibold text-slate-800">Adrian Przetocki</span>
                                            </div>
                                            <div class="text-xs text-slate-500 font-medium">1 Aug</div>
                                        </div>
                                        <div class="text-xs font-medium text-slate-800 truncate mb-0.5">🙌 Help us
                            ...
                            <li class="-mx-2">
                                <button class="flex w-full p-2 rounded text-left"
                                        @click.stop="$emit('close-inboxsidebar')">
                                    <img class="w-8 h-8 rounded-full mr-2" src="../../../../images/user-32-02.jpg"
                                         width="32" height="32" alt="User 05"/>
                                    <div class="grow truncate">
                                        <div class="flex items-center justify-between mb-1.5">
                                            <div class="truncate">
                                        ...
                                        <div class="text-xs font-medium text-slate-800 truncate mb-0.5">Re: Here’s an
                                            extra 25% OFF 🎉
                                        </div>
                                        <div class="text-xs whitespace-normal">Excepteur sint occaecat cupidatat non
                                            proident sunt in culpa qui deserunt…
                                        </div>
                                    </div>
                                </button>
                            </li>
