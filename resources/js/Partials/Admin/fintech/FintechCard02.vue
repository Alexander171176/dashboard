            ...
            <div class="relative w-full max-w-sm mx-auto bg-slate-800 p-3 rounded-2xl">
                ...
                <div
                    ...
                    <div class="absolute left-0 -bottom-1/3 w-[398px] aspect-square" aria-hidden="true">
                        <svg class="w-full h-full" width="398" height="392" viewBox="0 0 398 392"
                            ...
                            <circle class="fill-indigo-100 opacity-60" filter="url(#glow-a)" cx="85" cy="85" r="85"
                    ...
                    <div class="absolute right-0 -top-1/3 w-[398px] aspect-square" aria-hidden="true">
                        <svg class="w-full h-full" width="398" height="392" viewBox="0 0 398 392"
                            ...
                            <circle class="fill-sky-400 opacity-60" filter="url(#glow-b)" cx="85" cy="85" r="85"
                ...
                <div class="space-y-2">
                    <div>
                        <div class="flex justify-between text-sm mb-2">
                            ...
                            <div class="text-slate-400 italic">$780,00 <span class="text-slate-500">/</span> $1,500.00
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between text-sm mb-2">
                            ...
                            <div class="text-slate-400 italic">$179,00 <span class="text-slate-500">/</span> $1,000.00
                            </div>
                        </div>
                        <div class="relative w-full h-2 bg-slate-600">
