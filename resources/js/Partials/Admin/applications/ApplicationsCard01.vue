    ...
    <div
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="grow flex flex-col p-5">
                        ...
                        <div class="flex space-x-1">
                            <button>
                                ...
                                <svg class="w-4 h-4 fill-current"
                                     :class="Math.round(item.rating) > 0 ? 'text-amber-500' : 'text-slate-300'"
                                     viewBox="0 0 16 16">
                                    <path
                            ...
                            <button>
                                ...
                                <svg class="w-4 h-4 fill-current"
                                     :class="Math.round(item.rating) > 1 ? 'text-amber-500' : 'text-slate-300'"
                                     viewBox="0 0 16 16">
                                    <path
                                        d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z"/>
                                </svg>
                            ...
                            <button>
                                ...
                                <svg class="w-4 h-4 fill-current"
                                     :class="Math.round(item.rating) > 2 ? 'text-amber-500' : 'text-slate-300'"
                                     viewBox="0 0 16 16">
                                    <path
                                        d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z"/>
                                </svg>
                            ...
                            <button>
                                ...
                                <svg class="w-4 h-4 fill-current"
                                     :class="Math.round(item.rating) > 3 ? 'text-amber-500' : 'text-slate-300'"
                                     viewBox="0 0 16 16">
                                    <path
                                        d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z"/>
                                </svg>
                            ...
                            <button>
                                ...
                                <svg class="w-4 h-4 fill-current"
                                     :class="Math.round(item.rating) > 4 ? 'text-amber-500' : 'text-slate-300'"
                                     viewBox="0 0 16 16">
                                    <path
                                        d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z"/>
                                </svg>
                ...
                <!-- Card footer -->
                <div>
                    <router-link class="btn-sm w-full bg-indigo-500 hover:bg-indigo-600 text-white" :to="item.link">
                        Install
                    </router-link>
                </div>
            </div>
