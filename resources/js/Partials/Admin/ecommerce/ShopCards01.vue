...
<template>
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="grow flex flex-col p-5">
                ...
                <div class="grow">
                    <!-- Header -->
                    <header class="mb-3">
                        <h3 class="text-lg text-slate-800 font-semibold">HTML, CSS, JavaScript - Build 6 Creative
                            Projects</h3>
                    </header>
                    <!-- Rating and price -->
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <img class="w-full" src="../../../../images/applications-image-02.jpg" width="286" height="160"
                 alt="Application 02"/>
            <!-- Card Content -->
            <div class="grow flex flex-col p-5">
                <!-- Card body -->
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <img class="w-full" src="../../../../images/applications-image-03.jpg" width="286" height="160"
                 alt="Application 03"/>
            <!-- Card Content -->
            <div class="grow flex flex-col p-5">
                <!-- Card body -->
    ...
    <div
        ...
        <div class="flex flex-col h-full">
            <!-- Image -->
            <img class="w-full" src="../../../../images/applications-image-04.jpg" width="286" height="160"
                 alt="Application 04"/>
            <!-- Card Content -->
            <div class="grow flex flex-col p-5">
                <!-- Card body -->
