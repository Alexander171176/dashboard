    ...
    <article class="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <header class="pb-4">
            ...
            <div class="flex items-start space-x-3 mb-3">
                <h2 class="text-2xl text-slate-800 font-bold">Besides Product Hunt, where else should I promote my new
                    project? 🤔</h2>
                <!-- Upvote button -->
                <div class="shrink-0">
                    <button
        ...
        <div class="space-y-4 mb-6">
            <p>Looking for new ideas to get users, receive feedback, and increase exposure! Besides PH, where else do
                you showcase your product?</p>
            <p>Please advise 🙌</p>
        </div>
        <!-- Comment form -->
        <div>
            <div class="flex items-start space-x-3 mb-3">
                <img class="rounded-full shrink-0" src="../../../../images/user-40-02.jpg" width="40" height="40"
                     alt="User 02"/>
                <div class="grow">
                    <label for="comment" class="sr-only">Write a comment…</label>
                    <textarea id="comment" class="form-textarea w-full focus:border-slate-300" rows="4"
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <div class="grow text-sm text-slate-800 space-y-2 mb-2">
                                <p>We've also had the same question to be honest. And for Appy.com launch we decided to
                                    go with Twitter as a primary medium and then Product Hunt as the other one. And I
                                    have to say that it led to some great results as Twitter allows you to be super
                                    active and engage in many conversations.</p>
                                <p>Also, users are there and everything is super active. So that will be my advice -
                                    invest time in Twitter</p>
                            </div>
                            <!-- Comment footer -->
                            <div class="flex flex-wrap text-xs">
                                <div
                                    ...
                                    <a class="block mr-2" href="#0">
                                        <img class="rounded-full" src="../../../../images/user-28-02.jpg" width="24"
                                ...
                                <div>
                                    ...
                                    <div class="grow text-sm text-slate-800 space-y-2 mb-2">
                                        <p>That's great advice, <a
                                            class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">@ekuplu89</a>
                                            👏</p>
                                    </div>
                                    <!-- Comment footer -->
                                    <div class="flex flex-wrap text-xs">
                ...
                <li class="relative pl-9 space-y-5">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <!-- Comment text -->
                            <div class="grow text-sm text-slate-800 space-y-2 mb-2">
                                <p>If you are a SaaS product and are looking for early adopters, AppSumo seems to be a
                                    great place to list on. Most of the users there seem to be early-adopters. Life-time
                        ...
                        <div>
                            ...
                            <div class="grow text-sm text-slate-800 space-y-2 mb-2">
                                <p>Thank you very much for all the people who are posting other alternatives! I will
                                    launch my free product design course in February and I will make a notion template
                                                ...
                                                <div
                                                    ...
                                                    <a class="block mr-2" href="#0">
                                                        <img class="rounded-full"
                                                             src="../../../../images/user-28-09.jpg" width="24"
                                                             height="24" alt="User 09"/>
                                                    </a>
                                                    <a class="font-medium text-indigo-500 hover:text-indigo-600"
                                                       href="#0">davidp1</a>
