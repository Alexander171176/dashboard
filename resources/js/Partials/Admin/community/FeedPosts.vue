<script>
import EditMenu from '@/Components/Admin/DropdownEditMenu.vue'
...
<template>
    ...
    <div class="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <header class="flex justify-between items-start space-x-3 mb-3">
            ...
            <div class="flex items-start space-x-3">
                <img class="rounded-full shrink-0" src="../../../../images/user-40-03.jpg" width="40" height="40"
                     alt="User 03"/>
                <div>
        ...
        <div class="text-sm text-slate-800 space-y-2 mb-5">
            ...
            <p>It's more likely that people reading your blog will opt in with their email addresses if you give them
                something highly relevant in return. Ditch that too-general lead magnet and create "content upgrades"
                for your highest-traffic articles.</p>
            <p>Thread 👇</p>
        </div>
        <!-- Footer -->
            ...
            <div class="relative !my-4">
                ...
                <div class="absolute left-0 right-0 bottom-0 p-4 bg-black bg-opacity-25 backdrop-blur-md">
                    <div class="flex items-center justify-between">
                        ...
                        <a class="text-xs font-medium text-indigo-400 hover:text-indigo-300" href="#0">Learn More
                            -&gt;</a>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <header class="flex justify-between items-start space-x-3 mb-3">
            <!-- User -->
            <div class="flex items-start space-x-3">
                <img class="rounded-full shrink-0" src="../../../../images/user-40-04.jpg" width="40" height="40"
                     alt="User 04"/>
                <div>
                    <div class="leading-tight">
        ...
        <div class="mt-5 pt-3 border-t border-slate-200">
            <ul class="space-y-2 mb-3">
                ...
                <li class="p-3 bg-slate-50 rounded">
                    <div class="flex items-start space-x-3">
                        <img class="rounded-full shrink-0" src="../../../../images/user-32-04.jpg" width="32"
                             height="32" alt="User 04"/>
                        <div>
                            <div class="text-xs text-slate-500">
                                <a class="font-semibold text-slate-800" href="#0">Sophie Wenner</a> · 44min
                            </div>
                            <div class="text-sm"><a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">@EricaSpriggs</a>
                ...
                <li class="p-3 bg-slate-50 rounded">
                    <div class="flex items-start space-x-3">
                        <img class="rounded-full shrink-0" src="../../../../images/user-32-05.jpg" width="32"
                        ...
                        <div>
                            ...
                            <div class="text-sm">Depends on the company you're running, but if I had to choose just one
                                book, it'd be The Personal MBA by Josh Kaufman.
                            </div>
                        </div>
                    </div>
                </li>
            ...
            <div class="flex justify-between space-x-2">
                <div class="text-sm text-slate-500"><span class="font-medium text-slate-600">2</span> of <span
                    class="font-medium text-slate-600">67</span> comments
                </div>
                <button class="text-sm  font-medium text-indigo-500 hover:text-indigo-600">View More Comments</button>
            </div>
            <!-- Comment form -->
            <div class="flex items-center space-x-3 mt-3">
                <img class="rounded-full shrink-0" src="../../../../images/user-40-02.jpg" width="32" height="32"
                     alt="User 02"/>
                <div class="grow">
    ...
    <div class="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <header class="flex justify-between items-start space-x-3 mb-3">
            <!-- User -->
            <div class="flex items-start space-x-3">
                <img class="rounded-full shrink-0" src="../../../../images/user-40-08.jpg" width="40" height="40"
                     alt="User 08"/>
                <div>
                    <div class="leading-tight">
        ...
        <div class="text-sm text-slate-800 space-y-2 mb-5">
            ...
            <div class="relative flex items-center justify-center !my-4">
                <img class="block w-full" src="../../../../images/feed-image-02.jpg" width="590" height="332"
                     alt="Feed 01"/>
                <button class="absolute group">
                    <svg class="w-16 h-16" width="64" height="64" xmlns="http://www.w3.org/2000/svg">
                        <circle class="fill-white opacity-80 group-hover:opacity-100 transition" cx="32" cy="32"
                                r="32"/>
