        ...
        <div class="p-6 space-y-6">
            ...
            <section>
                <div class="mb-8">
                    ...
                    <div class="text-sm">This workspace’s Basic Plan is set to <strong class="font-medium">$34</strong>
                        per month and will renew on <strong class="font-medium">July 9, 2021</strong>.
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <div class="text-sm text-slate-500 font-medium">Annually <span
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div
                            ...
                            <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                                ...
                                <div class="text-slate-800 font-bold mb-4">
                                    ...
                                    class="text-3xl">{{ annual ? '14' : '19' }}</span><span
                                    class="text-slate-500 font-medium text-sm">/mo</span>
                                </div>
                                <!-- CTA -->
                                <button class="btn border-slate-200 hover:border-slate-300 text-slate-600 w-full">
                                    Downgrade
                                </button>
                            </div>
                        ...
                        <div
                            ...
                            <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                                ...
                                <div class="text-slate-800 font-bold mb-4">
                                    <span class="text-2xl">$</span><span
                                    class="text-3xl">{{ annual ? '34' : '39' }}</span><span
                                    class="text-slate-500 font-medium text-sm">/mo</span>
                                </div>
                                <!-- CTA -->
                                <button
                        ...
                        <div
                            ...
                            <div class="px-5 pt-5 pb-6 border-b border-slate-200">
                                ...
                                <div class="text-slate-800 font-bold mb-4">
                                    <span class="text-2xl">$</span><span
                                    class="text-3xl">{{ annual ? '74' : '79' }}</span><span
                                    class="text-slate-500 font-medium text-sm">/mo</span>
                                </div>
                                <!-- CTA -->
            ...
            <section>
                ...
                <ul class="space-y-5">
                    ...
                    <li>
                        ...
                        <div class="text-sm">
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
                            anim id est laborum in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                        </div>
                    </li>
                    <li>
                        <div class="font-semibold text-slate-800 mb-1">
                        ...
                        <div class="text-sm">
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
                            anim id est laborum in voluptate velit esse cillum dolore eu fugiat <a
                            class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">contact us</a>.
                        </div>
                    </li>
                </ul>
            </section>
