                ...
                <ul>
                    <li class="flex justify-between items-center py-3 border-b border-slate-200">
                        ...
                        <div class="flex items-center ml-4">
                            ...
                            <div class="form-switch">
                                <input type="checkbox" id="comments" class="sr-only" v-model="comments" true-value="On"
                                       false-value="Off"/>
                    ...
                    <li class="flex justify-between items-center py-3 border-b border-slate-200">
                        ...
                        <div class="flex items-center ml-4">
                            ...
                            <div class="form-switch">
                                <input type="checkbox" id="messages" class="sr-only" v-model="messages" true-value="On"
                                       false-value="Off"/>
                    ...
                    <li class="flex justify-between items-center py-3 border-b border-slate-200">
                        ...
                        <div>
                            ...
                            <div class="text-sm">Excepteur sint occaecat cupidatat non in culpa qui officia deserunt
                                mollit.
                            </div>
                        </div>
                        <!-- Right -->
                        <div class="flex items-center ml-4">
                            ...
                            <div class="form-switch">
                                <input type="checkbox" id="mentions" class="sr-only" v-model="mentions" true-value="On"
                                       false-value="Off"/>
