    ...
    <div class="grow flex flex-col md:translate-x-0 transition-transform duration-300 ease-in-out"
        ...
        <div class="sticky top-16">
            <div
                ...
                <div class="flex">
                    ...
                    <button
                        class="p-1.5 shrink-0 rounded bg-white border border-slate-200 hover:border-slate-300 shadow-sm ml-2">
                ...
                <div class="flex items-center">
                    <div class="text-xs mr-1"><span class="font-medium">10</span> <span class="text-slate-500">of</span>
                        <span class="font-medium">467</span></div>
                    <button
                        class="p-1.5 shrink-0 rounded bg-white border border-slate-200 hover:border-slate-300 shadow-sm ml-2">
        ...
        <div class="grow px-4 sm:px-6 md:px-5 py-4">
            ...
            <header class="sm:flex sm:items-start sm:justify-between mb-4">
                <h1 class="text-xl leading-snug text-slate-800 font-bold mb-1 sm:mb-0 ml-2">Chill your mind with this
                    amazing offer 🎉</h1>
                <button
                    class="text-xs inline-flex font-medium bg-sky-100 text-sky-600 rounded-full text-center px-2.5 py-1 whitespace-nowrap">
                    Exciting news
                </button>
            </header>
