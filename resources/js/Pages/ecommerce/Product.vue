    ...
    <AdminLayout>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
                ...
                <div>
                    <div class="mb-3">
                        <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">&lt;- Back To
                            Listing</a>
                    </div>
                    <header class="mb-4">
                        <!-- Title -->
                        <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2">Front-End Learning: Hands-On HTML
                            & CSS In Real Web Apps ✨</h1>
                    ...
                    <!-- Image -->
                    <figure class="mb-6">
                        <img class="w-full rounded-sm" src="../../../images/product-image.jpg" width="640" height="360"
                             alt="Product"/>
                    </figure>
                    ...
                    <div>
                        ...
                        <ul class="space-y-5 my-6">
                            ...
                            <li>
                                <div class="flex items-center mb-2">
                                    <img class="w-8 h-8 rounded-full mr-3" src="../../../images/user-32-07.jpg"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div class="flex space-x-1">
                                                ...
                                                <button>
                                                    <span class="sr-only">5 stars</span>
                                                    <svg class="w-4 h-4 fill-current text-slate-300"
                                                         viewBox="0 0 16 16">
                                                        <path
                                                            d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z"/>
                                                    </svg>
                                ...
                                <div class="text-sm italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                            ...
                            <li>
                                <div class="flex items-center mb-2">
                                    <img class="w-8 h-8 rounded-full mr-3" src="../../../images/user-32-05.jpg"
                            ...
                            <li>
                                <div class="flex items-center mb-2">
                                    <img class="w-8 h-8 rounded-full mr-3" src="../../../images/user-32-03.jpg"
                            ...
                            <li>
                                <div class="flex items-center mb-2">
                                    <img class="w-8 h-8 rounded-full mr-3" src="../../../images/user-32-04.jpg"
                        ...
                        <div class="text-center">
                            <button
                                class="btn bg-white border-slate-200 hover:border-slate-300 text-indigo-500 hover:text-slate-600">
                                Load More Reviews
                            </button>
                        </div>
                    </div>
                        ...
                        <ul class="space-y-8 sm:space-y-5 my-6">
                            ...
                            <li class="sm:flex items-center">
                                <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                    <img class="rounded-sm" src="../../../images/related-product-01.jpg" width="200"
                                         height="142" alt="Product 01"/>
                                </a>
                                <div class="grow">
                                    <a href="#0">
                                        <h3 class="text-lg font-semibold text-slate-800 mb-1">The Complete Front-End
                                            Development Course!</h3>
                                    </a>
                                    <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                            ...
                            <li class="sm:flex items-center">
                                <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                    <img class="rounded-sm" src="../../../images/related-product-02.jpg" width="200"
                                         height="142" alt="Product 02"/>
                                </a>
                                <div class="grow">
                                    <a href="#0">
                                        <h3 class="text-lg font-semibold text-slate-800 mb-1">Web Development Ultimate
                                            Course 2021</h3>
                                    </a>
                                    <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut.
                            ...
                            <li class="sm:flex items-center">
                                <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                    <img class="rounded-sm" src="../../../images/related-product-03.jpg" width="200"
                                         height="142" alt="Product 03"/>
                                </a>
                                <div class="grow">
                                    <a href="#0">
                                        <h3 class="text-lg font-semibold text-slate-800 mb-1">Full-Stack JavaScript
                                            Course!</h3>
                                    </a>
                                    <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut.
                ...
                <div>
                    <div class="bg-white p-5 shadow-lg rounded-sm border border-slate-200 lg:w-72 xl:w-80">
                        ...
                        <div class="mb-4">
                            <a class="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white" href="#0">Buy Now -
                                $69.00</a>
                        </div>
                        <div class="text-xs text-slate-500 italic text-center">Lorem ipsum dolor sit amet, consectetur
