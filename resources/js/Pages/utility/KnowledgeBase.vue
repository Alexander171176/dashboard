            ...
            <div class="absolute pointer-events-none" aria-hidden="true">
                <svg width="512" height="512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle style="mix-blend-mode:overlay" cx="588" cy="650" r="256" transform="translate(-332 -394)"
                            fill="url(#ill-a)" fill-rule="evenodd" opacity=".48"/>
                </svg>
            </div>
            <!-- Illustration -->
            <div class="absolute pointer-events-none" aria-hidden="true">
                    ...
                    <div
                        ...
                        <div class="bg-slate-100 rounded-sm text-center p-5">
                            <div class="flex flex-col h-full">
                                        ...
                                        <svg class="w-12 h-12" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g fill-rule="nonzero" fill="none">
                                                ...
                                                <path
                                                    ...
                                                    fill="url(#icon1-a)" transform="translate(-.93 -.005)"/>
                                            </g>
                                        </svg>
                                    </div>
                                    <!-- Content -->
                                ...
                                <!-- Link -->
                                <div>
                                    <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">Explore
                                        -&gt;</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <svg class="w-12 h-12" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g fill-rule="nonzero" fill="none">
                                                ...
                                                <path
                                                    ...
                                                    fill="url(#icon4-a)" transform="rotate(-8 126.748 -40.297)"/>
                                                <path d="M25.194 25.777a3 3 0 1 1-.835-5.942 3 3 0 0 1 .835 5.942Z"
                                                      fill="#6366F1" opacity=".72"/>
                                            </g>
                                        </svg>
                                    </div>
                                    <!-- Content -->
                                        ...
                                        <svg class="w-12 h-12" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g fill-rule="nonzero" fill="none">
                                                ...
                                                <path
                                                    ...
                                                    fill="url(#icon5-a)" transform="rotate(16 -34.482 60.533)"/>
                                            </g>
                                        </svg>
                                    </div>
                                    <!-- Content -->
                                        ...
                                        <svg class="w-12 h-12" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g fill-rule="nonzero" fill="none">
                                                ...
                                                <path
                                                    ...
                                                    fill="url(#icon6-a)" transform="rotate(8 -86.45 77.005)"/>
                                                <path fill="#6366F1" opacity=".72"
                                        ...
                                        <svg class="w-12 h-12" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g fill-rule="nonzero" fill="none">
                                                ...
                                                <path
                                                    ...
                                                    fill="url(#icon8-a)" transform="rotate(13 -42.427 83.827)"/>
                                            </g>
                                        </svg>
                                    </div>
                                    <!-- Content -->
                        ...
                        <div class="w-full p-3 rounded-sm text bg-white border border-slate-200">
                            <div class="flex h-full">
                                ...
                                <div class="flex flex-col h-full">
                                    <!-- Content -->
                                    <div class="grow mb-2">
                                        <div class="font-semibold text-slate-800 mb-1">Documents For Business
                                            Verification
                                        </div>
                                        <div class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing sed do
                        ...
                        <div class="w-full p-3 rounded-sm text bg-white border border-slate-200">
                            <div class="flex h-full">
                                ...
                                <div class="flex flex-col h-full">
                                    <!-- Content -->
                                    <div class="grow mb-2">
                                        <div class="font-semibold text-slate-800 mb-1">Update Existing Bank Account
                                            Information
                                        </div>
                                        <div class="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing sed do
                                            eiusmod tempor incididunt ut labore et dolore.
