                    ...
                    <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
                        ...
                        <div class="flex shrink-0 -space-x-3 -ml-px">
                            <a class="block" href="#0">
                                <img class="rounded-full border-2 border-slate-100 box-content"
                                     src="../../../../images/user-32-08.jpg" width="32" height="32" alt="User 08"/>
                            </a>
                            <a class="block" href="#0">
                                <img class="rounded-full border-2 border-slate-100 box-content"
                                     src="../../../../images/user-32-07.jpg" width="32" height="32" alt="User 07"/>
                            </a>
                            <a class="block" href="#0">
                                <img class="rounded-full border-2 border-slate-100 box-content"
                                     src="../../../../images/user-32-05.jpg" width="32" height="32" alt="User 05"/>
                            </a>
                            <button
                ...
                <div class="space-y-6">
                                        ...
                                        <div class="flex shrink-0 -space-x-3 -ml-px">
                                            <a class="block" href="#0">
                                                <img class="rounded-full border-2 border-white box-content"
                                                     src="../../../../images/user-32-07.jpg" width="24" height="24"
                                                     alt="User 07"/>
                                            </a>
                                            <a class="block" href="#0">
                                                <img class="rounded-full border-2 border-white box-content"
                                                     src="../../../../images/user-32-05.jpg" width="24" height="24"
                                                     alt="User 05"/>
                                            </a>
                                        </div>
                                        <!-- Like button -->
                                ...
                                <div class="sm:flex sm:justify-between sm:items-start">
                                    ...
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <div class="flex shrink-0 -space-x-3 -ml-px">
                                            <a class="block" href="#0">
                                                <img class="rounded-full border-2 border-white box-content"
                                                     src="../../../../images/user-32-08.jpg" width="24" height="24"
                                                     alt="User 08"/>
                                            </a>
                                            <a class="block" href="#0">
                                                <img class="rounded-full border-2 border-white box-content"
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <!-- Task -->
                            <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4 opacity-60"
                                 draggable="true">
                                <div class="sm:flex sm:justify-between sm:items-start">
                                    <!-- Left side -->
                                    <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
