                        ...
                        <article class="pt-6">
                            <div class="xl:flex">
                                <div class="w-32 shrink-0">
                                    <h2 class="text-xl leading-snug font-bold text-slate-800 xl:leading-7 mb-4 xl:mb-0">
                                        2021 Q1</h2>
                                </div>
                                            ...
                                            <div class="flex shrink-0 -space-x-3 -ml-px">
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-05.jpg" width="28" height="28"
                                                         alt="User 05"/>
                                                </a>
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-08.jpg" width="28" height="28"
                                                         alt="User 08"/>
                                                </a>
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-09.jpg" width="28" height="28"
                                                         alt="User 09"/>
                                                </a>
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-06.jpg" width="28" height="28"
                                                         alt="User 06"/>
                                                </a>
                                            </div>
                                    ...
                                    <ul class="-my-2">
                                        ...
                                        <li class="relative py-2">
                                            <div class="flex items-center mb-1">
                                                ...
                                                <h3 class="text-lg font-bold text-slate-800 pl-9">Product V1 - Early
                                                    Access</h3>
                                            </div>
                                            <div class="pl-9">Duis aute irure dolor in reprehenderit in voluptate velit
                                        ...
                                        <li class="relative py-2">
                                            <div class="flex items-center mb-1">
                                                ...
                                                <h3 class="text-lg font-bold text-slate-800 pl-9">Web3
                                                    Compatibility</h3>
                                            </div>
                                            <div class="pl-9">Duis aute irure dolor in reprehenderit in voluptate velit
                                                esse cillum dolore eu fugiat nulla pariatur.
                                        ...
                                        <li class="relative py-2">
                                            <div class="flex items-center mb-1">
                                                ...
                                                <h3 class="text-lg font-bold text-slate-800 pl-9">Proof-of-Funds
                                                    Compliance Key</h3>
                                            </div>
                                            <div class="pl-9">Duis aute irure dolor in reprehenderit in voluptate velit
                                                esse cillum dolore eu fugiat nulla pariatur.
                                        ...
                                        <li class="relative py-2">
                                            <div class="flex items-center mb-1">
                                                ...
                                                <h3 class="text-lg font-bold text-slate-800 pl-9">Activity Feed
                                                    Integration</h3>
                                            </div>
                                            <div class="pl-9">Duis aute irure dolor in reprehenderit in voluptate velit
                                                esse cillum dolore eu fugiat nulla pariatur.
                                    ...
                                    <header>
                                        <div class="flex flex-nowrap items-center space-x-2 mb-6">
                                            ...
                                            <div class="flex shrink-0 -space-x-3 -ml-px">
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-03.jpg" width="28" height="28"
                                                         alt="User 03"/>
                                                </a>
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                ...
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-01.jpg" width="28" height="28"
                                                         alt="User 01"/>
                                                </a>
                                            </div>
                                            <div class="text-slate-400">·</div>
                                        ...
                                        <li class="relative py-2">
                                            <div class="flex items-center mb-1">
                                                <div class="absolute left-0 rounded-full bg-white" aria-hidden="true">
                                                    <svg class="w-5 h-5 fill-current text-slate-400"
                                                         viewBox="0 0 20 20">
                                                        <path
                                    ...
                                    <header>
                                        <div class="flex flex-nowrap items-center space-x-2 mb-6">
                                            ...
                                            <div class="flex shrink-0 -space-x-3 -ml-px">
                                                ...
                                                <a class="block" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-28-02.jpg" width="28" height="28"
                                                         alt="User 02"/>
                                                </a>
                                            </div>
                                            <div class="text-slate-400">·</div>
