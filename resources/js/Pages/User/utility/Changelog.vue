...
import PaginationClassic from '@/Components/User/PaginationClassic.vue'
                ...
                <div class="max-w-3xl m-auto mt-8">
                    ...
                    <div class="xl:-translate-x-16">
                        ...
                        <article class="pt-6">
                            <div class="xl:flex">
                                <div class="w-32 shrink-0">
                                    <div class="text-xs font-semibold uppercase text-slate-400 xl:leading-8">8 July,
                                        2021
                                    </div>
                                </div>
                                            ...
                                            <div class="flex items-center">
                                                <a class="block mr-2 shrink-0" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-32-07.jpg" width="32" height="32"
                                                         alt="User 04"/>
                                                </a>
                        ...
                        <article class="pt-6">
                            <div class="xl:flex">
                                <div class="w-32 shrink-0">
                                    <div class="text-xs font-semibold uppercase text-slate-400 xl:leading-8">6 July,
                                        2021
                                    </div>
                                </div>
                                <div class="grow pb-6 border-b border-slate-200">
                                    <header>
                                        <h2 class="text-2xl text-slate-800 font-bold mb-3">Feature Name is now public
                                            🎉</h2>
                                        <div class="flex flex-nowrap items-center space-x-2 mb-4">
                                            <div class="flex items-center">
                                                <a class="block mr-2 shrink-0" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-32-02.jpg" width="32" height="32"
                                                         alt="User 04"/>
                                                </a>
                                                <a class="block text-sm font-semibold text-slate-800" href="#0">
                                                    Danielle Cohen
                        ...
                        <article class="pt-6">
                            <div class="xl:flex">
                                <div class="w-32 shrink-0">
                                    <div class="text-xs font-semibold uppercase text-slate-400 xl:leading-8">4 July,
                                        2021
                                    </div>
                                </div>
                                <div class="grow pb-6 border-b border-slate-200">
                                    <header>
                                        <h2 class="text-2xl text-slate-800 font-bold mb-3">Bugs fixed, issues, and
                                            more</h2>
                                        <div class="flex flex-nowrap items-center space-x-2 mb-4">
                                            <div class="flex items-center">
                                                <a class="block mr-2 shrink-0" href="#0">
                                                    <img class="rounded-full border-2 border-white box-content"
                                                         src="../../../../images/user-32-01.jpg" width="32" height="32"
                                                         alt="User 04"/>
                                                </a>
                                                <a class="block text-sm font-semibold text-slate-800" href="#0">
                                                    Patrick Kumar
                        ...
                        <article class="pt-6">
                            <div class="xl:flex">
                                <div class="w-32 shrink-0">
                                    <div class="text-xs font-semibold uppercase text-slate-400 xl:leading-8">2 July,
                                        2021
                                    </div>
                                </div>
                                <div class="grow pb-6 border-b border-slate-200">
