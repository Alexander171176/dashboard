            ...
            <div class="max-w-3xl m-auto">
                ...
                <div class="mb-6">
                    <form class="relative">
                        ...
                        <input id="action-search" class="form-input pl-9 py-3 focus:border-slate-300 w-full"
                               type="search"/>
                ...
                <div>
                    ...
                    <article class="py-4 border-b border-slate-200">
                        <header class="flex items-start mb-2">
                            ...
                            <h3 class="text-xl leading-snug text-slate-800 font-bold">How can the widget to my
                                website?</h3>
                        </header>
                        <div class="pl-7">
                    ...
                    <article class="py-4 border-b border-slate-200">
                        <header class="flex items-start mb-2">
                            ...
                            <h3 class="text-xl leading-snug text-slate-800 font-bold">What would happen if I choose not
                                to pay after the usage?</h3>
                        </header>
                        <div class="pl-7">
                            <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud
                    ...
                    <article class="py-4 border-b border-slate-200">
                        <header class="flex items-start mb-2">
                            ...
                            <h3 class="text-xl leading-snug text-slate-800 font-bold">What limitations do trial accounts
                                have?</h3>
                        </header>
                        <div class="pl-7">
                            <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                    ...
                    <article class="py-4 border-b border-slate-200">
                        <header class="flex items-start mb-2">
                            ...
                            <h3 class="text-xl leading-snug text-slate-800 font-bold">Is there any difference between
                                Standard and Plus licenses?</h3>
                        </header>
                        <div class="pl-7">
                            <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud
                    ...
                    <article class="py-4 border-b border-slate-200">
                        <header class="flex items-start mb-2">
                            ...
                            <h3 class="text-xl leading-snug text-slate-800 font-bold">Is my personal information
                                protected?</h3>
                        </header>
                        <div class="pl-7">
                            <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                    ...
                    <article class="py-4 border-b border-slate-200">
                        <header class="flex items-start mb-2">
                            ...
                            <h3 class="text-xl leading-snug text-slate-800 font-bold">What can I create with with this
                                product?</h3>
                        </header>
                        <div class="pl-7">
                            <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                ...
                <div class="mt-6">
                    <div class="flex justify-end">
                        <a class="btn bg-white border-slate-200 hover:border-slate-300 text-indigo-500" href="#0">See
                            All Questions -&gt;</a>
                    </div>
                </div>
