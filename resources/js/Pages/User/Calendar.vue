        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="sm:flex sm:justify-between sm:items-center mb-4">
                ...
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">
                        <span>{{ `${monthNames[month]} ${year}` }}</span> ✨</h1>
                </div>
            ...
            <div class="sm:flex sm:justify-between sm:items-center mb-4">
                ...
                <div class="mb-4 sm:mb-0 mr-2">
                    <ul class="flex flex-wrap items-center -m-1">
                        ...
                        <li class="m-1">
                            <button class="btn-sm bg-white border-slate-200 hover:border-slate-300 text-indigo-500">+Add
                                New
                            </button>
                        </li>
                    </ul>
            ...
            <div class="bg-white rounded-sm shadow overflow-hidden">
                ...
                <div class="grid grid-cols-7 gap-px bg-slate-200">
                    ...
                    <div class="bg-slate-50 h-20 sm:h-28 lg:h-36" v-for="(blankday, index) in startingBlankDays"
                         :key="index">
                        ...
                        <div class="h-full flex flex-col justify-between">
                            ...
                            <div class="grow flex flex-col relative p-0.5 sm:p-1.5 overflow-hidden">
                                <button
                                    ...
                                    :key="index"
                                >
                                    <div class="px-2 py-0.5 rounded overflow-hidden"
                            ...
                            <div class="flex justify-between items-center p-0.5 sm:p-1.5">
                                ...
                                >
                                    <span class="md:hidden">+</span><span>{{ getEvents(day).length - 2 }}</span> <span
                                ...
                                <button
                                    ...
                                    :class="{'text-indigo-500': isToday(day) }">{{ day }}
                                </button>
                            </div>
                        </div>
                    </div>
                    <!-- Empty cells (next month) -->
                    <div class="bg-slate-50 h-20 sm:h-28 lg:h-36" v-for="(blankday, index) in endingBlankDays"
                         :key="index">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                            <rect width="100%" height="100%" fill="url(#stripes)"/>
                        </svg>
