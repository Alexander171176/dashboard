...
import DropdownClassic from '@/Components/User/DropdownClassic.vue'
import DropdownFull from '@/Components/User/DropdownFull.vue'
import DropdownFilter from '@/Components/User/DropdownFilter.vue'
import DropdownProfile from '@/Components/User/DropdownProfile.vue'
import DropdownSwitch from '@/Components/User/DropdownSwitch.vue'
import DropdownNotifications from '@/Components/User/DropdownNotifications.vue'
import DropdownHelp from '@/Components/User/DropdownHelp.vue'
import DropdownEditMenu from '@/Components/User/DropdownEditMenu.vue'
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="border-t border-slate-200">
                ...
                <div class="space-y-8 mt-8 mb-80">
                    ...
                    <div>
                        <h2 class="text-2xl text-slate-800 font-bold mb-6">Datepicker (built with <a
                            class="underline hover:no-underline" href="https://github.com/flatpickr/flatpickr"
                            target="_blank" rel="noreferrer">flatpickr</a>)</h2>
                        <Datepicker/>
                    </div>
