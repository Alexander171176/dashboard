                    ...
                    <div>
                        ...
                        <div class="grid gap-5 md:grid-cols-3">
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        ...
                                        <Tooltip class="ml-2" bg="dark" size="md">
                                            <div class="text-sm text-slate-200">Excepteur sint occaecat cupidata non
                                                proident, sunt.
                                            </div>
                                        </Tooltip>
                                    </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="supporting-text">W/
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center -m-3">
                            ...
                            <div class="m-3 w-24">
                                ...
                                <div class="flex items-center mt-5">
                                    <div class="form-switch">
                                        <input type="checkbox" id="toggle1" class="sr-only" v-model="toggle1"
                            ...
                            <div class="m-3 w-24">
                                ...
                                <div class="flex items-center mt-5">
                                    <div class="form-switch">
                                        <input type="checkbox" id="toggle2" class="sr-only" v-model="toggle2"
                                               true-value="On" false-value="Off"/>
                            ...
                            <div class="m-3 w-32">
                                ...
                                <div class="flex items-center mt-5">
                                    <div class="form-switch">
                                        <input type="checkbox" id="toggle3" class="sr-only" v-model="toggle3"
                                               true-value="On" false-value="Off" disabled/>
