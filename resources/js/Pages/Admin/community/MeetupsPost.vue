    ...
    <AdminLayout>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
                ...
                <div>
                    <div class="mb-6">
                        <router-link class="btn-sm px-3 bg-white border-slate-200 hover:border-slate-300 text-slate-600"
                    ...
                    <div class="text-sm font-semibold text-indigo-500 uppercase mb-2">Mon 27 Dec, 2021 - 9:00 PM -&gt;
                        10:00 PM
                    </div>
                    <header class="mb-4">
                        <!-- Title -->
                        <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2">The World of AI and Machine
                            Learning — Open Chat</h1>
                    ...
                    <div class="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                        ...
                        <div class="flex items-center sm:mr-4">
                            <a class="block mr-2 shrink-0" href="#0">
                                <img class="rounded-full" src="../../../../images/user-32-07.jpg" width="32" height="32"
                                     alt="User 04"/>
                            </a>
                            <div class="text-sm whitespace-nowrap">Hosted by <a class="font-semibold text-slate-800"
                                                                                href="#0">Monica Fishkin</a></div>
                        </div>
                        <!-- Right side -->
                        <div class="flex flex-wrap items-center sm:justify-end space-x-2">
                            <!-- Tags -->
                            <div
                                class="text-xs inline-flex items-center font-medium bg-white text-slate-600 rounded-full text-center px-2.5 py-1">
                    ...
                    <!-- Image -->
                    <figure class="mb-6">
                        <img class="w-full rounded-sm" src="../../../../images/meetup-image.jpg" width="640" height="360"
                             alt="Meetup"/>
                    </figure>
                    ...
                    <div>
                        ...
                        <p class="mb-6">In the world of AI, behavioural predictions are leading the charge to better
                            machine learning.</p>
                        <p class="mb-6">There is so much happening in the AI space. Advances in the economic sectors
                            have seen automated business practices rapidly increasing economic value. While the realm of
                            the human sciences has used the power afforded by computational capabilities to solve many
                            human based dilemmas. Even the art scene has adopted carefully selected ML applications to
                            usher in the technological movement.</p>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-4 my-6">
                            <a class="block" href="#0">
                                <img class="w-full rounded-sm" src="../../../../images/meetup-photo-01.jpg" width="203"
                                     height="152" alt="Meetup photo 01"/>
                            </a>
                            <a class="block" href="#0">
                                <img class="w-full rounded-sm" src="../../../../images/meetup-photo-02.jpg" width="203"
                                     height="152" alt="Meetup photo 02"/>
                            </a>
                            <a class="block" href="#0">
                                <img class="w-full rounded-sm" src="../../../../images/meetup-photo-03.jpg" width="203"
                                     height="152" alt="Meetup photo 03"/>
                            </a>
                        </div>
                    </div>
                        ...
                        <ul class="space-y-5 my-6">
                            ...
                            <li class="flex items-start">
                                <a class="block mr-3 shrink-0" href="#0">
                                    <img class="rounded-full" src="../../../../images/user-32-07.jpg" width="32"
                            ...
                            <li class="flex items-start">
                                <a class="block mr-3 shrink-0" href="#0">
                                    <img class="rounded-full" src="../../../../images/user-32-08.jpg" width="32"
                            ...
                            <li class="flex items-start">
                                <a class="block mr-3 shrink-0" href="#0">
                                    <img class="rounded-full" src="../../../../images/user-32-02.jpg" width="32"
                        ...
                        <div class="space-y-8 sm:space-y-5 my-6 lg:mb-0">
                            ...
                            <article class="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
                                ...
                                <a class="relative block w-24 sm:w-56 lg:sidebar-expanded:w-20 xl:sidebar-expanded:w-56 shrink-0"
                                   href="#0">
                                    <img class="absolute object-cover object-center w-full h-full"
                                         src="../../../../images/meetups-thumb-02.jpg" width="220" height="236"
                                         alt="Meetup 02"/>
                                    <!-- Like button -->
                                ...
                                <div class="grow p-5 flex flex-col">
                                    <div class="grow">
                                        <div class="text-sm font-semibold text-indigo-500 uppercase mb-2">Mon 27 Dec,
                                            2021
                                        </div>
                                        <a class="inline-flex mb-2" href="#0">
                                            <h3 class="text-lg font-bold text-slate-800">New York & New Jersey Virtual
                                                Retreat 2021</h3>
                                        </a>
                                        <div class="text-sm">Lorem ipsum is placeholder text commonly used in the
                                    ...
                                    <div class="flex justify-between mt-3">
                                        <!-- Tag -->
                                        <div
                                            class="text-xs inline-flex items-center font-medium bg-slate-100 text-slate-600 rounded-full text-center px-2.5 py-1">
                                            <svg class="w-4 h-3 fill-slate-400 mr-2" viewBox="0 0 16 12">
                                                <path
                                                    d="m16 2-4 2.4V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.6l4 2.4V2ZM2 10V2h8v8H2Z"/>
                                            </svg>
