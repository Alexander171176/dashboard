...
import FeedLeftContent from '@/Partials/Admin/community/FeedLeftContent.vue'
import FeedPosts from '@/Partials/Admin/community/FeedPosts.vue'
import FeedRightContent from '@/Partials/Admin/community/FeedRightContent.vue'
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-white shadow-md rounded border border-slate-200 p-5">
                                    <div class="flex items-center space-x-3 mb-5">
                                        <img class="rounded-full shrink-0" src="../../../../images/user-40-02.jpg"
