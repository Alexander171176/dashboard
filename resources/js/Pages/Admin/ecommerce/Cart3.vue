            ...
            <div class="px-4 sm:px-6 lg:px-8 py-8 lg:grow lg:pr-8 xl:pr-16 2xl:ml-[80px]">
                <div class="lg:max-w-[640px] lg:mx-auto">
                    ...
                    <div class="mb-6 lg:mb-0">
                        ...
                        <header class="mb-6">
                            <!-- Title -->
                            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2">Thank you for your order
                                ✨</h1>
                            <p>You will soon receive a confirmation email with details of your order and a link to
                            ...
                            <form>
                                <div class="space-y-4">
                                    ...
                                    <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                                        ...
                                        <div class="flex-1">
                                            <label class="block text-sm font-medium mb-1"
                                                   for="card-surname">Surname</label>
                                    ...
                                    <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                                        <div class="flex-1">
                                            <label class="block text-sm font-medium mb-1"
                                                   for="card-address">Address</label>
                                            <input id="card-address" class="form-input w-full" type="text"/>
                                        </div>
                                        <div class="flex-1">
                                            <label class="block text-sm font-medium mb-1"
                                                   for="card-city">Town/City</label>
                                    ...
                                    <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                                        ...
                                        <div class="flex-1">
                                            <label class="block text-sm font-medium mb-1" for="card-country">Country
                    ...
                    <div class="py-8 px-4 lg:px-8 2xl:px-12">
                        <div class="max-w-sm mx-auto lg:max-w-none">
                            ...
                            <div class="space-y-6">
                                    ...
                                    <ul>
                                        ...
                                        <li class="flex items-center py-3 border-b border-slate-200">
                                            <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                                <img class="w-16 xl:w-20" src="../../../../images/related-product-01.jpg"
                                                     width="200" height="142" alt="Product 01"/>
                                            </a>
                                            <div class="grow">
                                                <a href="#0">
                                                    <h4 class="text-sm font-medium text-slate-800 leading-tight">The
                                                        Complete Front-End Development Course!</h4>
                                                </a>
                                            </div>
                                        ...
                                        <li class="flex items-center py-3 border-b border-slate-200">
                                            <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                                <img class="w-16 xl:w-20" src="../../../../images/related-product-02.jpg"
                                                     width="200" height="142" alt="Product 02"/>
                                            </a>
                                            <div class="grow">
                                                <a href="#0">
                                                    <h4 class="text-sm font-medium text-slate-800 leading-tight">Web
                                                        Development Ultimate Course 2021</h4>
                                                </a>
                                            </div>
                                            <div class="text-sm font-medium text-slate-800 ml-2">$69</div>
                                        </li>
                                        ...
                                        <li class="flex items-center py-3 border-b border-slate-200">
                                            <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                                <img class="w-16 xl:w-20" src="../../../../images/related-product-03.jpg"
                                ...
                                <div class="mt-6">
                                    <div class="mb-4">
                                        <router-link to="/ecommerce/pay"
                                                     class="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white">
                                            View Your Order
                                        </router-link>
                                    </div>
                                    <div class="text-xs text-slate-500 italic text-center">Should you ever change your
                                        mind, we offer a 14-day, no-questions-asked refund policy.
                                    </div>
                                </div>
