...
import CartItems from '@/Partials/Admin/ecommerce/CartItems.vue'
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        <!-- Card Number -->
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="card-nr">Card Number
                                        ...
                                        <div class="flex space-x-4">
                                            <div class="flex-1">
                                                <label class="block text-sm font-medium mb-1" for="card-expiry">Expiry
                                        ...
                                        <!-- Name on Card -->
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="card-name">Name on Card
                                                <span class="text-rose-500">*</span></label>
                                ...
                                <div class="mt-6">
                                    <div class="mb-4">
                                        <button class="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white">Pay
                                            $253.00
                                        </button>
                                    </div>
                                    <div class="text-xs text-slate-500 italic text-center">You'll be charged $253,
                                        including $48 for VAT in Italy
                                    </div>
                                </div>
