                        ...
                        <ul class="text-sm">
                            <li>
                                <router-link
                                    ...
                                    <span><span
                                        class="font-medium text-slate-800 group-hover:text-white">Messages</span> - Conversation / … / Mike Mills</span>
                                </router-link>
                            </li>
                            <li>
                                <router-link
                                    ...
                                    <span><span
                                        class="font-medium text-slate-800 group-hover:text-white">Messages</span> - Conversation / … / Eva Patrick</span>
                                </router-link>
                            </li>
                        </ul>
                    </div>
