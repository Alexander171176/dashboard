    ...
    <div class="relative inline-flex">
        ...
        >
            <div class="flex items-center truncate">
                <span
                    class="truncate font-medium text-indigo-500 group-hover:text-indigo-600">My Personal Account</span>
                ...
                >
                    <li>
                        <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex items-center py-1 px-3"
                           href="#0" @click="dropdownOpen = false">Business Account</a>
                    </li>
                    <li>
                        <a class="font-medium text-sm text-slate-600 hover:text-slate-800 flex items-center py-1 px-3"
                           href="#0" @click="dropdownOpen = false">Family Account</a>
                    </li>
                </ul>
            </div>
        </transition>
